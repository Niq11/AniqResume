               ...
               <section class="s-pageheader pageheader">
                    <div class="row">
                        <div class="column xl-12">
                            <h1 class="page-title">
                                <span class="page-title__small-type text-pretitle">My Art</span>
                                Recent Designers
                            </h1>
                        </div>
                    </div>
                                ...
                                <div class="grid-full grid-list-items">
                                    ...
                                    <div class="grid-list-items__item blog-card">
                                        <div class="blog-card__header">
                                            ...
                                            <h3 class="blog-card__title"><a href="https://www.dreamhost.com/r.cgi?287326">Aniq Muaddib</a></h3>
                                        </div>
                                    ...
                                    <div class="grid-list-items__item blog-card">
                                        <div class="blog-card__header">
                                            ...
                                            <h3 class="blog-card__title"><a href="single.html">Aniq Muaddib</a></h3>
                                        </div>
                                        <div class="blog-card__text">
										
										<img src="images/Fragile.jpg">
                                            <p>
                                            This stupid picture so weird
                                            </p>
                                        </div>
                                    </div> <!-- end blog-card -->
                                    ...
                                    <div class="grid-list-items__item blog-card">
                                        ...
                                        <div class="blog-card__text">
										<img src="images/Vociferate.png">
                                            <p>
                                            Laki bunga duri kasturi
                                            </p>
                                        </div>
                                    </div> <!-- end blog-card -->
        ...
        <footer class="s-footer">
            <div class="row s-footer__content">
                <div class="column xl-6 lg-6 md-12 s-footer__block s-footer__about">                    
                    <h3>About Aniq</h3>
                    <p>
                    Aniq Designer Gallery exhibits the creative abilities of Aniq, a gifted graphic designer who enjoys combining retro aesthetics with future themes.
					With a concentration on graphic design, Aniq's gallery provides insight into his distinct style and inventive approach to visual storytelling.
                    </p>               
                </div>                
