            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <nav class="s-header__nav">
                    ...
                    <ul class="s-header__menu-links">
                        ...
                        <li class="current"><a href="education.php">Education</a></li>
               ...
               <section class="s-pageheader pageheader">
                    <div class="row">
                        <div class="column xl-12">
                            <h1 class="page-title">
                                <span class="page-title__small-type text-pretitle">Education</span>
               ...
               <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        <div class="column xl-6 lg-12">
                            <h2 class="text-display-title">High-impact edcuation of <br>my life</h2>
                        </div>
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                            Aniq is now pursuing a degree in Multimedia Computing at UiTM Shah Alam, having previously studied Software and Application Development at Polytechnic Mukah. 
							With a solid educational foundation in technology and a passion for graphic design, 
							Aniq is well-positioned to use his talents and experience to pursue his entrepreneurial goals in the industry.
                            </p>
                        </div>                       
                    </div>  <!-- pageintro -->       
                            ...
                            <div class="grid-full grid-list-items list-items show-ctr">
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Living</h3>
                                    </div>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">SPM</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Diploma</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Resting</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
                                ...
                                <div class="grid-list-items__item list-items__item">
                                    <div class="list-items__item-header">
                                        <h3 class="list-items__item-title">Degree</h3>
                                    </div>
                                    <div class="list-items__item-text">
                                        <p>
